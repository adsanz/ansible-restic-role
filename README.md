...
Only install vars are viable on it's default value. To configure restic_locations and backends, just follow yaml guidelines and autorestic docs. It should be the same definition (thanks to jinja2 templating in ansible)
